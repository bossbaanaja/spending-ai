/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc29c082995764394d0d4a3375401817)
// Runtime types generated with workerd@1.20260701.1 2026-07-04 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NIM_MODELS: "minimaxai/minimax-m3,openai/gpt-oss-120b,nvidia/nemotron-3-super-120b-a12b,google/gemma-4-31b-it,z-ai/glm-5.2,meta/llama-3.2-90b-vision-instruct";
	BOT_TOKEN: string;
	WEBHOOK_SECRET: string;
	NVIDIA_API_KEY: string;
	TYPHOON_OCR_API_KEY: string;
	INVITE_TOKENS: string;
	ADMIN_TOKENS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NIM_MODELS" | "BOT_TOKEN" | "WEBHOOK_SECRET" | "NVIDIA_API_KEY" | "TYPHOON_OCR_API_KEY" | "INVITE_TOKENS" | "ADMIN_TOKENS">> {}
}
